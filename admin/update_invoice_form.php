        ...
        <div class="row">
            <div class="fifteen wide computer sixteen wide phone centered column center-table">
                ...
                <div class="ui grid">
                    <div class="sixteen wide computer sixteen wide phone centered column">
                        ...
                        <div class="ui stacked segment">
                            <div class="ui orange ribbon icon label">Update Invoice Information</div>
                            <br><br>
                            <?php
              ...
              ?>
                            ...
                            <form action="index.php?act=updateform_invoice" method="POST" enctype="multipart/form-data"
