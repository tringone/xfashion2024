                    ...
                    foreach ($kq as $client) {
                      ...
                      echo '
                        <tr>
                          ...
                          <td>
                            <button  class="button-update"><a class="change-a" href="index.php?act=updateform_client&id='.$client['id'].'">Update</a></button>
                          </td>
                        </tr>';
                      $i++;
                    }
                ...
                ?>
                            ...
                            <div>
                                <!-- <button class="button-delete"><a class="change-a"
                                        href="index.php?act=del_client&id='.$client['id'].'">Delete</a></button> -->
