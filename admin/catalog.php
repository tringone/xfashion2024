        ...
        <div class="ui grid">
          <div class="sixteen wide computer sixteen wide phone centered column">
            ...
            <div class="ui stacked segment">
                    ...
                    echo '
                      <tr>
                        ...
                        <td>'.$catalog['id_catalog_k'].'</td>
                         ...
                         <td>
                         <div class="frame1">
                         <button class="button-update"><a class="change-a" href="index.php?act=updateform_catalog&id='.$catalog['id_catalog_k'].'">Update</a></button>
                         <button class="button-delete"><a class="change-a" href="index.php?act=del_catalog&id='.$catalog['id_catalog_k'].'">Delete</a></button> 
                         </div>
                          </td>
                      </tr>
                        ';
              ...
              <div>
              <button class="button-insert" ><a class="change-a" href="index.php?act=insert_catalog&id='1'">Insert</a></button>
              </div>
            </div>
            <!-- END DATATABLE -->
          </div>
