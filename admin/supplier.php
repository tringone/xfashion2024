        ...
        <div class="ui grid">
          <div class="sixteen wide computer sixteen wide phone centered column">
            ...
            <div class="ui stacked segment">
                    ...
                    echo '
                      <tr>
                        ...
                        <td>'.$supplier['sup_id'].'</td>
                         ...
                         <td>
                         <div class="frame1">
                         <button class="button-update"><a class="change-a" href="index.php?act=updateform_supplier&id='.$supplier['sup_id'].'">Update</a></button>
                         <button class="button-delete"><a class="change-a" href="index.php?act=del_supplier&id='.$supplier['sup_id'].'">Delete</a></button> 
                         </div>
                          </td>
                      </tr>
                        ';
              ...
              <div>
              <button class="button-insert" ><a class="change-a" href="index.php?act=insert_supplier&id='1'">Insert</a></button>
              </div>
            </div>
            <!-- END DATATABLE -->
          </div>
