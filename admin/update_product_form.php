        ...
        <div class="ui grid">
          <div class="sixteen wide computer sixteen wide phone centered column">
            ...
            <div class="ui stacked segment">
              <div class="ui orange ribbon icon label">Update Product Information</div>
              <br><br>
              <?php
              // echo var_dump($result);
              ?>
              <form action="index.php?act=updateform_product" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                    <label>Name</label>
