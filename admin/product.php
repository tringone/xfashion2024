        ...
        <div class="ui grid">
          <div class="sixteen wide computer sixteen wide phone centered column">
            ...
            <div class="ui stacked segment">
                    ...
                    foreach ($kq as $product) {
                      ...
                      echo '
                        <tr>
                          ...
                          <td>'.$name_supplier.'</td>
                          <td>
                            <button  class="button-update"><a class="change-a" href="index.php?act=updateform_product&id='.$product['id_product'].'">Update</a></button>
                            <button  class="button-delete"><a class="change-a" href="index.php?act=del_product&id='.$product['id_product'].'">Delete</a></button> 
                          </td>
                        </tr>';
                      $i++;
                    }
              ...
              <div>
                  <button  class="button-insert"><a class="change-a" href="index.php?act=insert_product&id='1'">Insert</a></button>
              </div>
            </div>
            <!-- END DATATABLE -->
          </div>
