          ...
          <div class="sixteen wide computer sixteen wide phone centered column">
            ...
            <div class="ui stacked segment">
              ...
              <table id="example" class="ui celled table responsive nowrap unstackable" style="width:100%">
                ...
                <td>
                  <button class="button-update"><a class="change-a" href="index.php?act=insert_client&id='1'">Insert client</a></button>
                </td>
                <td>
                  <button class="button-update"><a class="change-a" href="index.php?act=insert_supplier&id='1'">Insert supplier</a></button>
                </td>
                <td>
                  <button class="button-update"><a class="change-a" href="index.php?act=insert_invoice&id='1'">Insert invoice</a></button>
                </td>
                <td>
                  <button class="button-update"><a class="change-a" href="index.php?act=insert_product&id='1'">Insert product</a></button>
                </td>
                <td>
                  <button class="button-update"><a class="change-a" href="index.php?act=insert_catalog&id='1'">Insert catalog</a></button>
                </td>
              </table>
            </div>
            <!-- END DATATABLE -->
