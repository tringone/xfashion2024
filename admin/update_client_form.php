                ...
                <div class="ui grid">
                    <div class="sixteen wide computer sixteen wide phone centered column">
                        ...
                        <div class="ui stacked segment">
                            <div class="ui orange ribbon icon label">Update Client Information</div>
                            <br><br>
                            <?php
            //   echo var_dump($result);
              ?>
                            <form action="index.php?act=updateform_client" method="POST" enctype="multipart/form-data"
