                ...
                <div class="computer only row">
                    <div class="column">
                        <div class="ui top fixed menu navcolor">
                            <div class="item">
                                <img src="../admin/images/logo.png" alt="SimpleIU">
                            </div>
                            <div class="left menu">
                                <div class="nav item">
                                    <strong class="navtext">ADMINISTATOR</strong>
                                </div>
                            </div>
                            <div class="ui top pointing dropdown admindropdown link item right">
                                <img class="imgrad" src="../admin/images/user.png" alt="">
                    ...
                    <div class="column">
                        <div class="ui top fixed menu navcolor">
                            ...
                            <div class="right menu">
                                <div class="item">
                                    <strong class="navtext">ADMINISTRATOR PAGE</strong>
                                </div>
                                <div class="item">
